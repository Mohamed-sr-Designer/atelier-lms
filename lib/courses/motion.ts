...
export const aftereffects: Course = {
  ...
  reviews: [
    ...
    { name: "Hassan T.", role: "Freelance editor", text: "kont 5ayef men AE awy bas el course matratteb b tari2a t5aleek tefham mesh te7faz. el precomp lesson saved me f client revision نفس الأسبوع", stars: 5 },
    { name: "Lina Mostafa", role: "Social media manager", text: "Best 2,800 I spend this year. One freelance job return the money, like he say in the course. Now motion is my main service.", stars: 5 },
  ],
  rating: 4.9,
  ratingCount: 104,
  students: 410,
...
export const premiere: Course = {
  ...
  reviews: [
    { name: "ريم العتيبي", role: "صانعة محتوى — جدة", text: "درس المونتاج على الإيقاع رفع مستوى الريلز حقتي بشكل ما توقعته. الكورسات عندنا أغلى بثلاث مرات وما توصل نص الجودة ذي.", stars: 5 },
    ...
    { name: "Ali Ragab", role: "Photographer", text: "The color module alone is worth the price. My videos finally match my photos. Easy to follow, no boring talk, every lesson is short and clear.", stars: 4 },
  ],
  rating: 4.8,
  ratingCount: 86,
  students: 320,
