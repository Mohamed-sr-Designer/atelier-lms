...
- **6 courses** (3–5 hours each, zero filler). The business model: the four
  ...
  are **completely free**, start to finish; the two AI production tracks —
  ...
  practical projects, downloadable resources, a checkpoint quiz and a
  personally reviewed final project.
...
- **Full student experience** on a static host: register/login, checkout
  ...
  learning interface, quizzes, resource vault — all persisted in
