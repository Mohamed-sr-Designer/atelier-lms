...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      alternateName: "Mohamed Tarek",
      jobTitle: ["Art Director", "Graphic Designer", "Design Educator"],
