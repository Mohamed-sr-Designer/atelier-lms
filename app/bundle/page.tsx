...
export const metadata: Metadata = {
  ...
  description:
    "Both premium AI tracks in one enrollment: AI Photoshoot & Prompt Engineering + AI Video Generation. The complete camera-less campaign pipeline — 6+ hours, 2 reviewed final projects, EGP 5,200 instead of 6,000.",
